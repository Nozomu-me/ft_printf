...
/*   Updated: 2019/12/13 20:42:41 by amouassi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	*/
	...
	printf("--> \"%%d\" * others2 :D\n");
	SP("EXPECTED","--> \"%%d\" * others2 :D\n");
	SP("TESTS","--> \"%%d\" * others2 :D\n");
	...
	printf("--> \"%%d\" * others3 :D\n");
	SP("EXPECTED","--> \"%%d\" * others3 :D\n");
	SP("TESTS","--> \"%%d\" * others3 :D\n");
	
	T("%u\n", UINT32_MAX);

	printf("--> \"%%d\" * others5 :D\n");
	SP("EXPECTED","--> \"%%d\" * others5 :D\n");
	SP("TESTS","--> \"%%d\" * others5 :D\n");
	...
	printf("--> \"%%d\" * others6 :D\n");
	SP("EXPECTED","--> \"%%d\" * others6 :D\n");
	SP("TESTS","--> \"%%d\" * others6 :D\n");

	T("%*d\n",4, -3);
	
	
	printf("--> \"%%d\" * others7 :D\n");
	SP("EXPECTED","--> \"%%d\" * others7 :D\n");
	SP("TESTS","--> \"%%d\" * others7 :D\n");

	T("%-*.*d\n", 4,3,1);
	

	printf("--> \"%%d\" * others8 :D\n");
	SP("EXPECTED","--> \"%%d\" * others8 :D\n");
	SP("TESTS","--> \"%%d\" * others8 :D\n");

	T("%-.3d\n",-2);
	

	printf("--> \"%%d\" * others9 :D\n");
	SP("EXPECTED","--> \"%%d\" * others9 :D\n");
	SP("TESTS","--> \"%%d\" * others9 :D\n");
	...
	printf("--> \"%%d\" * others12 :D\n");
	SP("EXPECTED","--> \"%%d\" * others12 :D\n");
	SP("TESTS","--> \"%%d\" * others12 :D\n");

	T("%0*.*d\n", 10,5, -32);


	printf("--> \"%%d\" * others13 :D\n");
	SP("EXPECTED","--> \"%%d\" * others13 :D\n");
	SP("TESTS","--> \"%%d\" * others13 :D\n");
	...
	printf("--> \"%%d\" * others14 :D\n");
	SP("EXPECTED","--> \"%%d\" * others14 :D\n");
	SP("TESTS","--> \"%%d\" * others14 :D\n");
	...
	printf("--> \"%%d\" * others15 :D\n");
	SP("EXPECTED","--> \"%%d\" * others15 :D\n");
	SP("TESTS","--> \"%%d\" * others15 :D\n");
	...
	printf("--> \"%%i\" * others16 :D\n");
	SP("EXPECTED","--> \"%%i\" * others16 :D\n");
	SP("TESTS","--> \"%%i\" * others16 :D\n");
